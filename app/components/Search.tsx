          ...
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-gray-900 mb-1">
              {searchResults.length > 0
                ...
                : "No results found? Try scraping fresh data!"}
            </h4>
            <p className="text-sm text-gray-600 leading-relaxed">
              Click the{" "}
              <span className="font-medium text-blue-600">"Scrap Data"</span>{" "}
              button to fetch fresh, updated data from our advanced scraping
              engine.
            </p>
          </div>
          <button
      ...
      <div className="w-full bg-gray-50 h-[calc(100vh-145px)] overflow-y-auto p-4">
        {loading ? (
            ...
            {searchResults.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-gray-500">
                ...
                <p className="text-center">
                  Try searching for influencers in different countries or
                  hashtags
                </p>
              </div>
            )}
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            ...
            <p className="text-center">
              Enter your search query to find influencers
            </p>
          </div>
        )}
      </div>
